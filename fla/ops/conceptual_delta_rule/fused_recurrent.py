...
def fused_recurrent_conceptual_delta_rule_fwd_kernel(
    q,
    k,
    v,
    g,
...
def fused_recurrent_conceptual_delta_rule_fwd(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    ...
    grid = (NV * N * HV,)
    fused_recurrent_conceptual_delta_rule_fwd_kernel[grid](
        q=q,
        k=k,
        v=v,
        g=g,
...
class FusedRecurrentFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        o, final_state = fused_recurrent_conceptual_delta_rule_fwd(
            q=q,
            k=k,
            v=v,
            g=g,
...
def fused_recurrent_conceptual_delta_rule(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    g: torch.Tensor | None = None,
    ...
    **kwargs,
    ...
    Examples::
        ...
        >>> from fla.ops.conceptual_delta_rule import fused_recurrent_conceptual_delta_rule
        ...
        >>> o, ht = fused_conceptual_recurrent_delta_rule(
            q, k, v, g, beta,
            initial_state=h0,
...
fused_recurrent_cdn = fused_recurrent_conceptual_delta_rule
