...
from fla.ops.conceptual_delta_rule.wy_fast import recompute_w_u_fwd
...
def chunk_conceptual_delta_rule_fwd_kkt_solve_kernel(
    k,
    g,
    beta,
    A,
...
def chunk_conceptual_delta_rule_fwd_intra(
    k: torch.Tensor,
    v: torch.Tensor,
    ...
    r"""
    cdn intra-chunk forward: fused or unfused kkt + solve_tril + recompute_w_u.
    ...
    if BT == 64 and not IS_INTEL:
        ...
        chunk_conceptual_delta_rule_fwd_kkt_solve_kernel[(NT, B * HV)](
            k=k,
            g=g,
            beta=beta,
            A=A,
