...
def naive_recurrent_conceptual_delta_rule(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    beta: torch.Tensor,
    ...
    """
    Reference PyTorch implementation of recurrent conceptual delta rule.
...
def naive_chunk_conceptual_delta_rule(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    g: torch.Tensor,
    ...
    """
    Reference PyTorch implementation of chunk conceptual delta rule.
